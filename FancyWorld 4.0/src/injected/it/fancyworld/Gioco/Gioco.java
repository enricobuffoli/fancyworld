...
public class Gioco extends Thread
{
    ...
    private final int LIM_CHIAVI = 5, LIM_PESO = 50, LIM_INF_PUNTEGGIO = 0, PUNTEGGIO_MINIMO_VITTORIA = 100;
    ...
    public void run()
    {
        while(true)
        {
            ...
            if(world.getCurrentLevel().getCurrentPlace(giocatore.getPosition()).getProva() != null)
            {
                String decision = "";
                ...
                {
                    if(world.getCurrentLevel().getCurrentPlace(giocatore.getPosition()).getProva().isAccomplished())
                    {
                        giocatore.setPunteggio(world.getCurrentLevel().getCurrentPlace(giocatore.getPosition()).getProva().getPunteggio(), Sign.PLUS);
                        System.out.println("Complimenti, hai guadagnato " + world.getCurrentLevel().getCurrentPlace(giocatore.getPosition()).getProva().getPunteggio() + " punti, arrivando a " + giocatore.getPunteggio() + " punti");
                    }
                    else
                    {
                        giocatore.setPunteggio(world.getCurrentLevel().getCurrentPlace(giocatore.getPosition()).getProva().getPunteggio(), Sign.MINUS);
                        if(giocatore.getPunteggio() < LIM_INF_PUNTEGGIO)
                            giocatore.setPunteggioToMin();
                        System.out.println("Che peccato, hai perso " + world.getCurrentLevel().getCurrentPlace(giocatore.getPosition()).getProva().getPunteggio() + " punti, arrivando a " + giocatore.getPunteggio() + " punti");
                    }
                }
            }
